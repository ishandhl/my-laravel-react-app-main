          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="col-span-2 relative ">
              <div className="bg-white mb-10">
                <h2 className="absolute transform text-white bg-blue-500  p-3 mt-3 ms-3 rounded-lg text-l font-semibold ml-1">
                  Featured Project
                </h2>
                {featuredProject && (
                  <div className="rounded-lg shadow-md overflow-hidden w-full h-96">
                    {" "}
                    {/* Adjusted height */}
                    <Link
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {randomProjects.map((project) => (
                  <div
                    ...
                    className="rounded-lg shadow-md overflow-hidden bg-white w-full "
                  >
                    {" "}
                    {/* Adjusted height */}
                    <Link
                    ...
                    <div className="p-2">
                      <div>
                        <h5 className="mb-2 text-sm font-bold leading-tight text-neutral-800 dark:text-neutral-50 text-left">
                          {project.project_title}
                        </h5>
                      </div>
                      <p className="mb-1 text-sm text-neutral-600 dark:text-neutral-200 text-left">
                      ...
                      <p className="mb-1 text-sm text-neutral-600 dark:text-neutral-200 text-left">
                        <span className="font-bold">Goal:</span> Rs.{" "}
