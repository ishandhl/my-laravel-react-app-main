        ...
        <div className="bg-gray-50 min-h-screen">
                ...
                <div className="container mx-auto px-4 py-8 max-w-6xl">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                        <div className="max-w-3xl">
                            <h1 className="text-3xl md:text-4xl font-bold mb-2">{project.project_title}</h1>
            ...
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                                ...
                                <div className="flex overflow-x-auto p-2 bg-gray-50 gap-2">
                                    {project.images.map((image, index) => (
                                        <div 
                                            ...
                                            className={`flex-shrink-0 cursor-pointer rounded-md overflow-hidden border-2 transition-all ${currentImageIndex === index ? 'border-blue-500 scale-105' : 'border-transparent'}`}
                                        >
                                            <img 
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-xl h-full">
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between mb-2">
                                    <span className="text-3xl font-bold text-gray-800">Rs. {project.total_amount_raised}</span>
                                    <span className="text-lg font-medium text-gray-500">of Rs. {project.funding_goal}</span>
                                </div>
                                ...
                                <div className="flex justify-between text-sm">
                                    <p className="font-medium text-blue-600">{fundingPercentage}% funded</p>
                                    <p className="text-gray-500">Goal: Rs. {project.funding_goal}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">{project.total_transactions}</p>
                                </div>
                                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                    <p className="text-gray-500 text-sm mb-1">Ends On</p>
                                    <p className="text-2xl font-bold text-gray-800">{project.end_date}</p>
                                </div>
                            </div>
                            ...
                            {project.status === 'Running' ? (
                                ...
                                <div className="mt-6 p-5 bg-red-50 border border-red-100 rounded-xl">
                                    ...
                                    <p className="text-red-500 ml-7">Current status: {project.status}</p>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    {updates && updates.length > 0 ? (
                        <div className="space-y-6">
                            {updates.map((update, index) => (
                                <div key={index} className="bg-blue-50 p-5 rounded-xl border-l-4 border-blue-400">
                ...
                {showModalDonate && (
                    <div className="fixed z-50 inset-0 overflow-y-auto">
                        <div className="flex items-center justify-center min-h-screen p-4">
                            <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm transition-opacity" onClick={() => setShowModalDonate(false)}></div>
                            ...
                            <div className="bg-white rounded-xl overflow-hidden shadow-2xl transform transition-all max-w-lg w-full z-10 border border-gray-100">
                                ...
                                <div className="p-6">
                                    <h4 className="text-xl font-bold mb-4 text-gray-800">{project.project_title}</h4>
                                    
                                    <div className="mb-6">
                                        <label htmlFor="donation-enter" className="block text-sm font-medium text-gray-700 mb-2">
                                            Enter Amount (Rs):
                                        </label>
                ...
                {showModalInvest && (
                    <div className="fixed z-50 inset-0 overflow-y-auto">
                        <div className="flex items-center justify-center min-h-screen p-4">
                            <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm transition-opacity" onClick={() => setShowModalInvest(false)}></div>
                            ...
                            <div className="bg-white rounded-xl overflow-hidden shadow-2xl transform transition-all max-w-3xl w-full z-10 border border-gray-100">
                                <div className="bg-gradient-to-r from-indigo-600 to-blue-600 p-5">
                                    <h3 className="text-xl font-bold text-white">Select Your Reward</h3>
                                </div>
                                    ...
                                    {project.rewards && project.rewards.length > 0 ? (
                                        <div className="space-y-6">
                                            {project.rewards.map((reward, index) => (
                                                <div key={index} className="border border-gray-200 rounded-xl p-5 hover:border-blue-300 transition-all duration-200 hover:shadow-md">
                                                    <div className="flex flex-col md:flex-row gap-6">
                                                        ...
                                                        <div className="md:w-2/3">
                                                            <h4 className="text-xl font-bold mb-2 text-gray-800">{reward.title}</h4>
                                                            <p className="text-gray-600 mb-4">{reward.description}</p>
                                                            
                                                            <div className="grid grid-cols-2 gap-4 mb-4">
                                                                <div className="bg-gray-50 p-3 rounded-lg">
                                                                    <p className="text-sm text-gray-500">Contribution</p>
                                                                    <p className="font-bold text-lg text-gray-800">Rs. {reward.minimumamount}</p>
                                                                </div>
                                                                <div className="bg-gray-50 p-3 rounded-lg">
                                                                    <p className="text-sm text-gray-500">Estimated Delivery</p>
                                                                    <p className="font-bold text-lg text-gray-800">{reward.estimated_delivery}</p>
                                                                </div>
                                                            </div>
                                        ...
                                        <div className="text-center py-8">
                                            ...
                                            <p className="text-gray-500 text-lg mt-4">No rewards are available for this project.</p>
                                        </div>
                                    )}
                                </div>
